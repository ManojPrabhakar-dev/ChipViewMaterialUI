...
{
    /// <summary>
    /// Interaction logic for TimingDiagram_DI_UserControl.xaml
    /// </summary>
    public partial class TimingDiagram_DI_UserControl : UserControl
    {
        public TimingDiagram_DI_UserControl()
        {
            InitializeComponent();
        }

        public TimingDiagram_DI_UserControl(TimingParametersModel timingParam, Brush path_brush, int slotNum)
        {
            InitializeComponent();
        ...
        public TimingDiagram_DI_UserControl(Brush path_brush, int SlotNum)
        {
            InitializeComponent();
